...
class raw extends file
{
     ...
     * @var string
     */
    protected mixed $paddingString = '';

    /**
     * padding mode to be used (left or right)
     * @var string|int
     */
    protected string|int $paddingMode = STR_PAD_RIGHT;
        ...
        foreach ($bufferArray as $buffered) {
            ...
            foreach ($this->structure as $rowIndex => $rowConfig) {
                ...
                foreach ($rowConfig as $columnIndex => $mappingKey) {
                    ...
                    $length = $mapping[$mappingKey]['length'] ?? 0;
                    // TODO:
                    ...
                    } elseif (mb_strlen($value, 'UTF-8') > $length) {
