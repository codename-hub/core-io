...
class subtractTest extends \codename\core\io\tests\transform\abstractTransformTest
{
  ...
  public function testValueValid(): void {
    $transform = $this->getTransform('calculate_subtract', [
      'fields'    => [
    ...
    $this->assertEquals(bcsub(bcsub(5.4321, 1.2345, 2), 1.2345, 2), $result);
  }
