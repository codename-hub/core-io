...
class genericPipelineTest extends abstractPipelineTest
{
    ...
    public function testPipeline(): void
    {
        ...
        static::assertInstanceOf(virtualTargetInterface::class, $target);

        if ($target instanceof virtualTargetInterface) {
    ...
    {
        $pipeline = new pipeline(null, $config);
        ...
        $pipeline = $this->executePipelineWithConfig([
          ...
          'target' => [
            'test' => [
              'type' => 'dummy',
              'mapping' => [
                  // 'somefield' => [ 'type' => 'transform', 'field' => 'nonexistent' ]
              ],
            ],
          ],
        ]);
    ...
    /**
     * [testPipelineFailsWithNonexistentTransform description]
     * @throws ReflectionException
     * @throws exception
     */
    public function testPipelineFailsWithNonexistentTransform(): void
    {
        $this->expectException(exception::class);
    ...
    /**
     * [testPipelineFailsWithNonexistentTransformDeep description]
     * @throws ReflectionException
     * @throws exception
     */
    public function testPipelineFailsWithNonexistentTransformDeep(): void
    {
        $this->expectException(exception::class);
        $this->expectExceptionMessage('EXCEPTION_CORE_IO_PIPELINE_MISSING_TRANSFORM');
        ...
        $this->executePipelineWithConfig([
          ...
          'target' => [
            'test' => [
              'type' => 'dummy',
              'mapping' => [
                'somefield' => ['type' => 'transform_deep', 'field' => ['nonexistent']],
              ],
            ],
          ],
        ]);
